...
// TOKEN DO BOT
define ('TOKEN_BOT', '5264175510:AAFqx9_TfAJ6a3Omo0KaU6z5dvZEZTYH58Y');
...
define ('CHAT_ID_NOTIFICACAO', '-1305678840'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-1684642883); // grupo de bot
